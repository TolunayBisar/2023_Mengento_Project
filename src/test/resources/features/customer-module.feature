...
Feature: Customer manager can manage customers
  ...
  Scenario: E-customer manager can filter customers by group
  ...
  @AssignCustomer
  Scenario: D-Customer Manager Can Assign a Customer To a Customer Group In The Actions
  ...
  @AddNewCustomerGroup
  Scenario: C-Customer manager should be able to add new customer group.
    Given Customer manager go to the manage customer page
    When Customer manager add new customer group.
    Then Added new customer group should be displayed.

  @DeleteCustomer
  Scenario: B-admin user can delete an existing customer
  ...
  @AddNewCustomer
  Scenario: A-Customer manager can add a new customer
    Given customer manager go to the manage customer page
